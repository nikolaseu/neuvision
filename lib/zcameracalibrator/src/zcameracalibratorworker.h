#ifndef Z3D_CAMERACALIBRATOR___ZCAMERACALIBRATORWORKER_H
#define Z3D_CAMERACALIBRATOR___ZCAMERACALIBRATORWORKER_H
...
#endif // Z3D_CAMERACALIBRATOR___ZCAMERACALIBRATORWORKER_H
