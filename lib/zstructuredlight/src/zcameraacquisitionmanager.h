#ifndef Z3D_STRUCTUREDLIGHT___ZCAMERAACQUISITIONMANAGER_H
#define Z3D_STRUCTUREDLIGHT___ZCAMERAACQUISITIONMANAGER_H
...
#endif // Z3D_STRUCTUREDLIGHT___ZCAMERAACQUISITIONMANAGER_H
