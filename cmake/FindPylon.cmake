...
elseif(MSVC)
  ...
  set(PYLON_LIB_SEARCH_PATH "$ENV{PYLON_DEV_DIR}/lib/x64")
...
elseif(UNIX)
  set(PYLON_DEV_DIR_SEARCH_PATH /opt/pylon5)
  # For more possible versions, just add more paths below.
  # list(APPEND PYLON_DEV_DIR_SEARCH_PATH "/somepath/include")

  find_program(PYLON_CONFIG pylon-config
               PATHS ${PYLON_DEV_DIR}
               PATHS $ENV{PYLON_DEV_DIR}
               PATHS ${PYLON_DEV_DIR_SEARCH_PATH}
               PATH_SUFFIXES bin)
